...
public class MeshGenerator : MonoBehaviour
{
    ...
    void SetupStartPos()
    {
        GameObject.Find("startPosP1_2P").transform.position = new UnityEngine.Vector3(0, maxTerrainHeight + 1, (zSize / 2) - 12);
        GameObject.Find("startPosP2_2P").transform.position = new UnityEngine.Vector3(0, maxTerrainHeight + 1, -(zSize / 2) + 12); 
        GameObject.Find("startPosP1_4P").transform.position = new UnityEngine.Vector3(-5, maxTerrainHeight + 1, (zSize / 2) - 12); 
        GameObject.Find("startPosP2_4P").transform.position = new UnityEngine.Vector3(5, maxTerrainHeight + 1, (zSize / 2) - 12); 
        GameObject.Find("startPosP3_4P").transform.position = new UnityEngine.Vector3(-5, maxTerrainHeight + 1, -(zSize / 2) + 12); 
        GameObject.Find("startPosP4_4P").transform.position = new UnityEngine.Vector3(5, maxTerrainHeight + 1, -(zSize / 2) + 12); 
